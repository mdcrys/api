...
//empresa
Route::post('/empresas/index', [EmpresaController::class, 'index']);
Route::post('/empresas/import', [EmpresaController::class, 'import']);
...
// Proyectos
Route::post('/proyectos/index', [ProyectoController::class, 'index']); // Para buscar con filtros
Route::post('/proyectos', [ProyectoController::class, 'store']);       // Crear nuevo proyecto
...
// Módulo
Route::post('/modulos/index', [ModuloController::class, 'index']);
Route::post('/modulos/import', [ModuloController::class, 'import']); // (si piensas importar por Excel u otros)
Route::put('/modulos/{id}', [ModuloController::class, 'update']);
Route::get('/modulos/config', [ModuloController::class, 'config']); // (si aplicas configuración por empresa o global)
Route::resource('modulos', ModuloController::class);


// Sección
Route::get('/modulos/{id}/secciones', [SeccionController::class, 'seccionesPorModulo']);

Route::post('/secciones/index', [SeccionController::class, 'index']);
Route::post('/secciones/import', [SeccionController::class, 'import']); // (opcional para importaciones)
Route::put('/secciones/{id}', [SeccionController::class, 'update']);
Route::get('/secciones/config', [SeccionController::class, 'config']); // (por si tienes configuración)
Route::resource('secciones', SeccionController::class);


//documentos
Route::post('/documentos/index', [DocumentoController::class, 'index']);
Route::post('/documentos/import', [DocumentoController::class, 'import']); // Si más adelante quieres importar
Route::put('/documentos/{id}', [DocumentoController::class, 'update']);    // Actualizar documento
Route::get('/documentos/config', [DocumentoController::class, 'config']); // Si necesitas configuración inicial
Route::resource('documentos', DocumentoController::class); // Crea rutas REST: index, store, show, update, destroy
